                    ...
                    {["desktop", "mobile"].map((key) => {
                        ...
                        return (
                            <button
                                ...
                                className="flex flex-col flex-1 justify-center gap-1 data-[active=true]:bg-primary/10 px-6 sm:px-8 py-4 sm:py-6 border-t sm:border-t-0 sm:border-l even:border-l text-left"
